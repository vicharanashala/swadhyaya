    ...
    <div className="grid lg:grid-cols-[1fr_300px] gap-4">
      ...
      <div className="space-y-3">
        ...
        <div className="text-[10px] text-dim leading-relaxed">
          The equation is a question. For any x you give it, the equation answers: y is <span className="text-accent">{probeY.toFixed(3)}</span>.
          Drag m to tilt the line. Drag c to slide it up and down. The probe shows how the equation maps x → y.
        </div>
      </div>
    </div>
  );
